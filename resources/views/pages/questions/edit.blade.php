...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    تعديل سؤال :<span class="text-danger">{{$question->content}}</span>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                            ...
                            <form action="{{ route('questions.update','test') }}" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="content" id="input-name"
                                               class="form-control form-control-alternative" value="{{$question->content}}">
