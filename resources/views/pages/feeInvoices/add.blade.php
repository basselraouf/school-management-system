                        ...
                        <form class=" row mb-30" action="{{ route('feeInvoices.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                        ...
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <input class="btn btn-danger btn-block" data-repeater-delete type="button" value="{{ trans('fees_trans.Delete') }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-20">
                                        <div class="col-12">
                                            <input class="button" data-repeater-create type="button" value="{{ trans('fees_trans.Add_New_Fee') }}"/>
                                        </div>
                                    </div><br>
